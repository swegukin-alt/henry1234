...
function Prompter({
  ...
  return (
    <div className={`${bgClass} fixed inset-0 overflow-hidden select-none`} style={{ fontFamily: "var(--font-prompter)" }}>
      ...
      <div className="absolute top-3 right-3 z-40 rounded-full bg-black/60 px-2.5 py-1 text-xs font-bold text-amber-300 tabular-nums backdrop-blur-sm" style={{ transform: mirrorV ? "scaleX(-1)" : undefined }}>
        {remaining}% left
      </div>
