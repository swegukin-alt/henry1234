...
export { cameraService, startCamera, stopCamera, switchCamera, setZoom, startRecording, cameraCapabilities, cameraDeviceCapabilities, cameraDiagnostics } from "./camera";
